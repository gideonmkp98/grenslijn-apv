...
### 1.1 FailRP
Het is verboden om opzettelijk rollenspel van lage kwaliteit te spelen dat de spelervaring negatief beïnvloedt.

!!! danger "Straf"
    **Categorie 2:** een ban van maximaal 1 dag

### 1.2 Powergaming
Het is niet toegestaan om bewust een oneerlijke of onrealistische wending te geven aan een scenario. Dit houdt in dat je de verhaallijn niet op een onnatuurlijke manier mag beïnvloeden of onrealistische dwang mag uitoefenen op andere partijen.
...
!!! warning "Zeer ernstige overtreding"
    ...
    - Mass RDM (grootschalig willekeurig doden)
    - Roleplay-ontwijkend gedrag
    - Kloten / Trollen
...
## Artikel 2 - Cheats & externe software

1. Het is niet toegestaan om gebruik te maken van software/hulpmiddelen (cheats of hacks) van derden om voordeel te behalen in het spel.
2. Het gebruik van crosshairs is strikt verboden.
...
!!! warning "Verdenking"
    Op basis van verdenking van het gebruik van cheats in de breedste zin, kan het managementteam besluiten een straf volgens categorie 7 op te leggen, zelfs zonder direct bewijs.

!!! info "Groepsverantwoordelijkheid"
    Wanneer meerdere leden van een groepering verbannen worden voor het gebruik van cheats, wordt de gehele groepering nauwlettend in de gaten gehouden door het staffteam. Op basis hiervan kan besloten worden de gehele groepering te verbannen.

!!! note "Privacyregeling"
    Grenslijn Roleplay hanteert een privacyregeling. Beslissingen worden mede gebaseerd op videomateriaal en andere informatiebronnen. Er worden geen PC-checks uitgevoerd. Het is echter wel mogelijk dat je een ban krijgt op basis van verdenking.

!!! warning "Uitgezoomed schieten"
    Uitgezoomed schieten is niet toegestaan vanwege crosshair-misbruik. Tickets met beeldmateriaal waarop dit zichtbaar is, worden direct afgekeurd.
...
1. Het is niet toegestaan om opzettelijk misbruik te maken van een bug of exploit om voordeel te behalen voor jezelf of anderen.
2. Alle voorwerpen en/of financiële bezittingen die voortkomen uit het gebruik van bugs en/of exploits worden verwijderd uit het spel.
3. Voorbeelden van bugs/exploits zijn: misbruik van bepaalde animaties (zoals schoppen vanaf een motor of emote bug abuse om te glitchen), het dupliceren van items, etc.
4. Wanneer het managementteam oordeelt dat het misbruik van een bug en/of exploit te veel invloed heeft op de economie, kunnen zij besluiten af te wijken van de standaard strafmaatregelen. Er zal dan een grondig onderzoek plaatsvinden naar de omstandigheden en gevolgen. Op basis hiervan kan een passende alternatieve maatregel worden genomen.
...
1. Het is niet toegestaan om informatie te gebruiken die buiten het spel om is verkregen.

!!! example "Voorbeelden"
    - Informatie verkregen uit Discord servers, bijvoorbeeld over illegale locaties of criminele organisaties
...
## Artikel 6 - Werk- en officiële kleding
...
2. Kledingstukken die vanuit Grenslijn zijn verstrekt aan officiële (criminele) groeperingen en de organisaties opgenomen in lid 4 mogen alleen gedragen worden wanneer jij daadwerkelijk lid bent van deze organisatie.
...
10. Vermeldt in een report duidelijk waarom je de report aangemaakt hebt. Reports als "rdm, vdm, kloter, staff nodig, kan staff komen" etc worden direct gesloten.
